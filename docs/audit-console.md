...
For each exact stream URL, the console lets you record:
...
7. Record provenance and notes when useful.
8. Click **Save & next**.
9. When the testing session is finished, run the normal strict build/tests before committing the changed `audit.json`.
