...
# Apply the already-validated builder/data patch from v2, then replace only
# its generated regression-test file with correctly escaped Python source.
runpy.run_path("tools/agent_clean_provider_test_names_v2.py", run_name="__main__")
...
print("Provider test-channel regression tests rewritten with safe escapes.")
